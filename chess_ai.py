...
pos2vec_state_dict = torch.load('pos2vec_200.pth.tar', map_location=lambda storage, loc: storage)
deepChess_state_dict = torch.load('deepchess_500.pth.tar', map_location=lambda storage, loc: storage)
